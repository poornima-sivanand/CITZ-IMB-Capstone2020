    ...
    stages {           
        ...
        stage('Deploy App Changes to DEV') {
            ...
            steps {
                ...
                sh 'oc process -f .openshiftio/deployment.yaml -p VERSION=1.0 | oc apply -n xordpe-dev -f -'
             }
           }
        }
        ...
        stage('Deploy App Changes to TEST') {             
            ...
            steps {
                ...
                sh 'oc process -f .openshiftio/deployment.yaml -p VERSION=1.0 | oc apply -n xordpe-test -f -'
            }
            }
        }
        ...
        stage('Deploy App Changes to PROD') {
            ...
            steps {
                ...
                sh 'oc process -f .openshiftio/deployment.yaml -p VERSION=1.0 | oc apply -n xordpe-prod -f -'
                }
              }
           }
